...
#%% Importações
    ...
    #X = df[['Pressao (mB)', 'Temperatura (°C)', 'Umidade (%)', 'UR_KWH', 'UR_KWh_TR',
    #        'UR_TEMP_ENTRADA', 'UR_TEMP_SAIDA', 'ur_temp_entrada_condensacao',
    #        'ur_temp_saida_condensacao', 'temp_externa', 'TR', 'Setpoint_AG',
    #        'delta_AG', 'delta_AC', 'FimDeSemana', 'HorarioComercial', 'VAG Predio', 'Ligados']]
    ...
    plt.title("Importância das Features TR")
    ...
    joblib.dump(scaler, 'predict_service/ModelsDeploy/TR/scaler.pkl')
    joblib.dump(model_rf, 'predict_service/ModelsDeploy/TR/model.pkl')
